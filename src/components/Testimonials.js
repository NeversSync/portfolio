...
import {
  TestimonialsWrapper, TestimonialsCopy, TestimonialsLink,
      ...
      <TestimonialsWrapper>
        ...
        <TestimonialsCard style={slideInOne} >
          <TestimonialsCopy>
            ...
            enough.<br/>
            <TestimonialsLink href="https://www.pascalevermont.com/" target="_blank" rel="noopener noreferrer">
              - Pascale Vermont
            </TestimonialsLink>
          </TestimonialsCopy>
        </TestimonialsCard>
        <TestimonialsCardTwo style={slideInTwo} >
          <TestimonialsCopy>
            ...
            to convey and took over! Many thanks to him.<br/>
            <TestimonialsLink href="https://www.langmorefees.com/" target="_blank" rel="noopener noreferrer">
              - Susan Langmore
            </TestimonialsLink>
          </TestimonialsCopy>
        </TestimonialsCardTwo>
